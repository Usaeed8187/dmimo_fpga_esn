...
int UHD_SAFE_MAIN(int argc, char *argv[])
{
    ...
    n321->set_tx_lo_source("internal", "lo1", 0);	// channel 0 txlo <- lo1
    n321->set_tx_lo_source("internal", "lo1", 1);	// channel 1 txlo <- lo1
    n321->set_rx_lo_source("internal", "lo1", 0);	// channel 0 rxlo <- lo1
    n321->set_rx_lo_source("internal", "lo1", 1);	// channel 1 rxlo <- lo1
    n321->set_tx_lo_export_enabled(false, "lo1", 0);
    n321->set_rx_lo_export_enabled(false, "lo1", 0);
    ...
    n321->get_device()->get_tree()->access<bool>(
        "/blocks/0/Radio#0/dboard/tx_frontends/0/los/lo1/lo_distribution/LO_OUT_1/export").set(false);
    n321->get_device()->get_tree()->access<bool>(
        "/blocks/0/Radio#0/dboard/tx_frontends/0/los/lo1/lo_distribution/LO_OUT_2/export").set(false);
    n321->get_device()->get_tree()->access<bool>(
        "/blocks/0/Radio#0/dboard/tx_frontends/0/los/lo1/lo_distribution/LO_OUT_3/export").set(false);
    n321->get_device()->get_tree()->access<bool>(
        "/blocks/0/Radio#0/dboard/rx_frontends/0/los/lo1/lo_distribution/LO_OUT_0/export").set(false);
    n321->get_device()->get_tree()->access<bool>(
        "/blocks/0/Radio#0/dboard/rx_frontends/0/los/lo1/lo_distribution/LO_OUT_1/export").set(false);
    n321->get_device()->get_tree()->access<bool>(
        "/blocks/0/Radio#0/dboard/rx_frontends/0/los/lo1/lo_distribution/LO_OUT_2/export").set(false);
    n321->get_device()->get_tree()->access<bool>(
