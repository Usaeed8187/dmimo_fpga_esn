...
#ifndef INCLUDED_NCJT_MU_CHANEST_IMPL_H
...
class mu_chanest_impl : public mu_chanest
{
private:
    ...
    void
    ltf_chan_est_2tx(gr_vector_const_void_star &input_items, gr_vector_void_star &output_items, int output_offset);
...
#endif /* INCLUDED_NCJT_MU_CHANEST_IMPL_H */
