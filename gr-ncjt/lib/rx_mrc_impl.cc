...
rx_mrc::sptr
rx_mrc::make(int rgmode, int nrx, int nsymbols, bool debug)
{
    return gnuradio::make_block_sptr<rx_mrc_impl>(rgmode, nrx, nsymbols, debug);
}

rx_mrc_impl::rx_mrc_impl(int rgmode, int nrx, int nsymbols, bool debug)
