...
stbc_decode::sptr
stbc_decode::make(int rgmode, int ndatasyms, int npilotsyms, bool debug)
{
    return gnuradio::make_block_sptr<stbc_decode_impl>(rgmode, ndatasyms, npilotsyms, debug);
}

stbc_decode_impl::stbc_decode_impl(int rgmode, int ndatasyms, int npilotsyms, bool debug)
