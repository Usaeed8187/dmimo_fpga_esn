...
ncjt_noair_1st_hop = ncjt.noair(rgmode, frames_per_sec, SNR, 0, False)

rg_demapper_phase1_debug = False or debug_all
rg_demapper_phase1_phase = 1
ncjt_rg_demapper_phase1 = ncjt.rg_demapper(rg_demapper_phase1_phase, rgmode, num_streams, True, True, rg_demapper_phase1_debug)

demapper_phase1_debug = False or debug_all
ncjt_demapper_phase1 = ncjt.demapper(rgmode, False, deterministic, demapper_phase1_debug)

remapper_phase1_debug = False or debug_all
ncjt_remapper_muxer_phase1 = ncjt.remapper_muxer(rgmode, num_streams, remapper_phase1_debug)
...
ncjt_noair_2nd_hop = ncjt.noair(rgmode, frames_per_sec, SNR, 0, False)

rg_demapper_phase2_debug = False or debug_all
rg_demapper_phase2_phase = 2
ncjt_rg_demapper_phase2 = ncjt.rg_demapper(rg_demapper_phase2_phase, rgmode, num_streams, True, True, rg_demapper_phase2_debug)

demapper_phase2_debug = False or debug_all
ncjt_demapper_phase2 = ncjt.demapper(rgmode, False, deterministic, demapper_phase2_debug)
...
##
ncjt_noair_3rd_hop_1 = ncjt.noair(rgmode, frames_per_sec, SNR, 0, False)
##
rg_demapper_phase3_1 = False or debug_all
rg_demapper_phase3_1_phase = 3
ncjt_rg_demapper_phase3_1 = ncjt.rg_demapper(rg_demapper_phase3_1_phase, rgmode, num_streams, True, False, rg_demapper_phase3_1)

if enable_pdc:
    ncjt_rg_mapper_phase3_2 = ncjt.rg_mapper(rgmode, num_streams, False, False, 2, 1, True, False, '')
    ##
    ncjt_noair_3rd_hop_2 = ncjt.noair(rgmode, frames_per_sec, SNR, 0, False)
    ##
    rg_demapper_phase3_2 = False or debug_all
    rg_demapper_phase3_2_phase = 3
    ncjt_rg_demapper_phase3_2 = ncjt.rg_demapper(rg_demapper_phase3_2_phase, rgmode, num_streams, True, False, rg_demapper_phase3_2)

if enable_pdc:
    pdc_debug = False or debug_all
    ncjt_pdc_0 = ncjt.pdc(rgmode, True, ncopies, 100, 0, deterministic, pdc_debug)
else:
    demapper_phase3_debug = True or debug_all
    ncjt_demapper_phase3 = ncjt.demapper(rgmode, False, deterministic, demapper_phase3_debug)
